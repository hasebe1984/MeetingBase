...
<form action="${pageContext.request.contextPath}/RoomEditServlet" method="post" class="form">
	<div class="input-wrap">
		...
		<input type="text" name="roomName" value="${roomDefault.name}${room.name}" id="roomName" class="form_input" required>
	</div>
	<div class="input-wrap">
		<label for="roomFloor">会議室階数</label>
		<input type="text" name="roomFloor" value="${roomDefault.id}${room.id}" id="roomFloor" class="form_input" required>
	</div>
